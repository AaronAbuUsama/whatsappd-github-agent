...
title: Agent API | Flue
image: https://flueframework.com/docs/og4.jpg
---

# Agent API

Last updated Jun 21, 2026 [ View as Markdown ](https://flueframework.com/docs/api/agent-api/index.md) 
...
Other session failures reject with typed `FlueError` subclasses such as `SessionBusyError`, `SkillNotRegisteredError`, and `SubagentNotDeclaredError`, all importable from `@flue/runtime`. See the [Errors Reference](https://flueframework.com/docs/api/errors-reference/) for the full vocabulary.
