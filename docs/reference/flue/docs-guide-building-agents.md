...
Last updated Jun 22, 2026 [ View as Markdown ](https://flueframework.com/docs/guide/building-agents/index.md) 
...
Actions let the model call finite agent-backed operations, tools execute bounded application functions, and skills provide reusable guidance. For more details, see [Actions](https://flueframework.com/docs/guide/actions/), [Tools](https://flueframework.com/docs/guide/tools/), [Skills](https://flueframework.com/docs/guide/skills/), [Sandboxes](https://flueframework.com/docs/guide/sandboxes/), and [Database](https://flueframework.com/docs/guide/database/).
...
* [Actions](https://flueframework.com/docs/guide/actions/), [Tools](https://flueframework.com/docs/guide/tools/), [Skills](https://flueframework.com/docs/guide/skills/), and [Sandboxes](https://flueframework.com/docs/guide/sandboxes/) — configure what an agent can do and where it works.
...
* [Schedules](https://flueframework.com/docs/guide/schedules/) — invoke finite workflows or dispatch continuing agent input on a schedule.
