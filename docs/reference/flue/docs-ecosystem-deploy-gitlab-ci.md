...
title: Build Agents for GitLab CI/CD | Flue
image: https://flueframework.com/docs/og4.jpg
---

# Build Agents for GitLab CI/CD

AI-generated, awaiting review [ View as Markdown ](https://flueframework.com/docs/ecosystem/deploy/gitlab-ci/index.md) 
...
| ------------------- | ----------------------------------------------- |
| ANTHROPIC\_API\_KEY | API key for your LLM provider                   |
| GITLAB\_API\_TOKEN  | Project or personal access token with api scope |
