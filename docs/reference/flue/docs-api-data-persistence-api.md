...
title: Data Persistence API | Flue
...
Application code usually configures an adapter through `db.ts`; see [Database](https://flueframework.com/docs/guide/database/). Always typecheck an adapter against the package exports. If this page and the package differ, the package wins.
