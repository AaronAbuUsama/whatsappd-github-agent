...
Last updated Jun 18, 2026 [ View as Markdown ](https://flueframework.com/docs/guide/evals/index.md) 
...
For protected deployments, configure the SDK client with the required token or headers. See [Vitest Evals tooling](https://flueframework.com/docs/ecosystem/tooling/vitest-evals/) for setup and reporting details.
...
Current page: [Evals](https://flueframework.com/docs/guide/evals/)
