...
Last updated Jun 13, 2026 [ View as Markdown ](https://flueframework.com/docs/ecosystem/channels/discord/index.md) [  @flue/discord ](https://www.npmjs.com/package/@flue/discord) 
...
Use `channel.conversationKey(ref)` when a Discord destination should continue the same agent instance. Conversation keys are identifiers, not authorization capabilities. See the shared [Channels guide](https://flueframework.com/docs/guide/channels/) for dispatch, authorization, and deduplication guidance.
