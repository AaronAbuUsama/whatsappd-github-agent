...
Last updated Jun 12, 2026 [ View as Markdown ](https://flueframework.com/docs/guide/skills/index.md) 
...
For executable application capabilities, use a [tool](https://flueframework.com/docs/guide/tools/). For application-controlled, multi-step agent work, use an [Action](https://flueframework.com/docs/guide/actions/).
