...
title: What is an agent? | Flue
image: https://flueframework.com/docs/og4.jpg
---

# What is an agent?

Last updated May 29, 2026 [ View as Markdown ](https://flueframework.com/docs/concepts/agents/index.md) 
...
// Bind finite orchestration to that policy.
