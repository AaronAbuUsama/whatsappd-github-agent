...
title: Deploy Agents on Render | Flue
image: https://flueframework.com/docs/og4.jpg
---

# Deploy Agents on Render

Last updated Jun 20, 2026 [ View as Markdown ](https://flueframework.com/docs/ecosystem/deploy/render/index.md) 
...
| Variable                               | Purpose                                                                                               |
| -------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| ANTHROPIC\_API\_KEY / OPENAI\_API\_KEY | Authenticates calls to your model provider. Use the name your provider expects.                       |
