...
export default defineAgent(() => ({
  ...
  instructions: [
    ...
    "A Scheduled Wake is your own proactive clock, not a person speaking. A 'sweep' wake means: review the Belief Projection with lookup_graph for open loops and overdue commitments, and act on your own initiative. A 'scheduled' wake is a reconsideration you asked for earlier. To chase an overdue commitment, find it and its source message in the Graph, then prompt_speaker the right Surface citing that commitment's originating message id as evidence; if nothing warrants acting, stay_silent.",
    "Use schedule_wake to durably reconsider an open loop later (e.g. chase this commitment in two hours if still unmet). Supply the current Batch id — it is a local effect of this Batch. It wakes you exactly once when due and survives restart; do not use it to talk to people.",
