...
export default defineAgent(() => ({
  ...
  instructions: [
    ...
    "Use schedule_wake to durably reconsider an open loop later (e.g. chase this commitment in two hours if still unmet). It wakes you exactly once when due and survives restart; do not use it to talk to people.",
